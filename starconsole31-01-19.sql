...
# Tiempo de Generaci髇: 2019-02-01 02:10:19 +0000
# ************************************************************
...
VALUES
	...
	(88,'fichausuario','ficha','2018-12-05 19:45:51','2018-12-05 19:45:51',31,NULL,2,0),
	...
	(154,'perfilcategoria','perfil','2019-01-31 20:43:23','2019-01-31 20:43:23',2,NULL,2,0);
...
VALUES
	...
	(6,'opcionesdisponibles','opcionesdisponibles/:id','opcionesdisponibles/\' + id','Obtiene todas las opciones disponibles de una versi贸n','Version.findById(req.params.id)\n.then(item => item.$get(\'Opciones\', { where : {  status : 1  } }))\n.then(response => resolve(response))','2018-11-06 20:29:51','2018-11-06 20:31:41',9,1,'get','id'),
	...
	(24,'verificarProducto','verificarProducto/:id','verificarProducto/\' + id','Verificar si el producto esta ligado a una promoci贸n activa',NULL,'2018-12-20 02:33:53','2018-12-20 02:33:53',17,1,'get','id'),
	...
	(32,'margenes','margenes/:id','margenes/\' + id','Se obtiene todos los margenes de una versi贸n',NULL,'2019-01-25 20:53:29','2019-01-25 20:53:55',9,1,'get','id'),
	(33,'sincronizarPrecios','sincronizarPrecios','sincronizarPrecios\'','Se analizan todos los inventarios, se jalan los precios y margenes del activo y se actualizar el precio de la versi贸n',NULL,'2019-01-26 05:46:11','2019-01-26 05:46:11',9,1,'get',NULL),
